...
def printKey(key):
  ...
  if (key=="1"):
    ...
    disp.display()
    time.sleep(2)
    os.system("python ~/Desktop/GIH/fingerprint/enroll_trial.py")
    ...
    disp.display()
    time.sleep(2)
    os.system("python ~/Desktop/GIH/fingerprint/search.py") 
    ...
    disp.display()
    time.sleep(2)
    os.system("python ~/Desktop/GIH?fingerprint/example_delete.py") 
    print("Going to Delete")
  else :
    disp.clear()
    disp.display()
    draw.rectangle((0,0,width,height), outline=0, fill=0)   
    draw.text((x, top + 16),'Wrong Input' ,  font=font, fill=255)
    disp.image(image)
    disp.display()
    time.sleep(2)
    print("wrong input")
...
disp.display()
draw.rectangle((0,0,width,height), outline=0, fill=0) 
draw.text((x, top),'Das Info Media:' ,  font=font, fill=5)
draw.text((x, top + 8),'Press 1 for Enroll :' ,  font=font, fill=5)
draw.text((x, top + 16),'Press 2-Attendance:' ,  font=font, fill=5)
draw.text((x, top + 24),'Press 3 for Delete :' ,  font=font, fill=5)
disp.image(image)
disp.display()
